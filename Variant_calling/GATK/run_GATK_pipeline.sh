#!/bin/bash
orig_bam1="/data/Nanopore/colorado_yeast/Processed_bams/GRL1691.rgadded.mkdup.bam"
orig_bam2="/data/Nanopore/colorado_yeast/Processed_bams/GRL1693.rgadded.mkdup.bam"
